...
#elif CONFIG_CONS_INDEX == 1 && defined(CONFIG_MACH_SUN8I_V851S)
	sunxi_gpio_set_cfgpin(SUNXI_GPH(9), SUN8I_V851S_GPH_UART0);
	sunxi_gpio_set_cfgpin(SUNXI_GPH(10), SUN8I_V851S_GPH_UART0);
